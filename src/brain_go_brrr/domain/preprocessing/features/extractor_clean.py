...
class ExtractedFeatures:
    ...
    window_features: Optional[npt.NDArray[np.float32]] = None
    channel_features: Optional[npt.NDArray[np.float32]] = None
    global_features: Optional[npt.NDArray[np.float32]] = None
    metadata: dict = None
