...
class EEGTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, chan_ids: Optional[torch.Tensor] = None) -> torch.Tensor:
        """
        Forward pass.
...
def create_eegpt_model(checkpoint_path: Optional[str] = None, **kwargs) -> EEGTransformer:
    """
