...
class TUEVEventExtractor:
    ...
    def extract_segments(self, 
                        edf_path: Path, 
                        annotations: List[Dict]) -> List[Tuple[npt.NDArray[np.float32], int]]:
        ...
        for annot in annotations:
            ...
            assert segment.shape == (23, samples_per_segment), f"Segment shape {segment.shape} != (23, {samples_per_segment})"
