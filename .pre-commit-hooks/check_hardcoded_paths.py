...
def check_file(filepath: Path) -> list[str]:
    ...
    patterns = [
        ...
        (
            r'SC4001E0-PSG\.edf',
            'Hardcoded Sleep-EDF filename - use DataConfig.get_sleep_edf_psg_file()',
        ),
        (
            r'sleep-edf-database-expanded-[\d.]+',
            'Hardcoded Sleep-EDF version - use DataConfig.sleep_edf_version',
        ),
        ...
        (
            r'/abnormal/01_tcp_ar',
            'Hardcoded TUAB structure - use DataConfig.get_tuab_sample_file()',
        ),
