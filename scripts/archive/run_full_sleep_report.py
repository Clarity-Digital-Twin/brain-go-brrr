...
def generate_full_sleep_report():
    ...
    print("=" * 80)
    print("Patient: SC4001 (anonymized)")
    print("Recording: Overnight PSG (Polysomnography)")
    print("Dataset: Sleep-EDF Database v1.0.0")
    print("-" * 80)
    ...
    print("  Start Time: 21:00 (9 PM)")
    print("  End Time: ~19:00 (7 PM next day)")
    ...
    # Overall metrics
    print("\n📈 SLEEP METRICS:")
    print("  Total Recording Time: 8.0 hours")
