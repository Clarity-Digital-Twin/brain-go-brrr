...
def test_simple_eegpt():
    ...
    channel_names = ['Fp1', 'Fp2', 'F3', 'F4', 'C3', 'C4', 'P3', 'P4', 'O1', 'O2',
                     'F7', 'F8', 'T3', 'T4', 'P7', 'P8', 'Fz', 'Cz', 'Pz']
    
    features = model.extract_features(window, channel_names)
    print(f"✅ Features extracted")
    print(f"   Shape: {features.shape}")
    print(f"   Expected: (4, 512)")  # 4 summary tokens, 512 dims
    ...
    print(f"✅ Batch features extracted")
    print(f"   Shape: {batch_features.shape}")
    print(f"   Expected: (5, 4, 512)")
    ...
    print(f"✅ Abnormality prediction")
