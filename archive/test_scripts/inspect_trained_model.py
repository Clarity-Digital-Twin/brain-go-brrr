...
if model_path.exists():
    ...
    if isinstance(checkpoint, dict) and "model_state_dict" in checkpoint:
        ...
        linear_layers = [k for k in state_dict.keys() if "linear" in k.lower() or "fc" in k.lower() or k.startswith("0.") or k.startswith("2.")]
        if linear_layers:
        ...
        backbone_layers = [k for k in state_dict.keys() if "backbone" in k.lower() or "encoder" in k.lower()]
        if backbone_layers:
