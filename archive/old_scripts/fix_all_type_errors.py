...
def main():
    ...
    fixes = {
        ...
        "src/brain_go_brrr/api/cache.py": [
            ...
            ("def get_stats(self) -> dict:", "def get_stats(self) -> dict[str, Any]:"),
            ("def health_check(self) -> dict:", "def health_check(self) -> dict[str, Any]:"),
        ],
        ...
        "src/brain_go_brrr/preprocessing/eeg_preprocessor.py": [
            (") -> list[np.ndarray]:", ") -> list[npt.NDArray[np.float64]]:"),
        ],
        # Fix Redis type
        ...
        "src/brain_go_brrr/data/edf_streaming.py": [
            ("def get_info(self) -> dict:", "def get_info(self) -> dict[str, Any]:"),
            ("def get_file_info(self) -> dict:", "def get_file_info(self) -> dict[str, Any]:"),
            ("-> dict:", "-> dict[str, Any]:"),
        ],
        ...
        "src/brain_go_brrr/api/dependencies.py": [
            ("job_store: dict[str, dict] = {}", "job_store: dict[str, dict[str, Any]] = {}"),
            (
        ...
        "src/brain_go_brrr/visualization/pdf_report.py": [
            ("eeg_data: npt.NDArray | None", "eeg_data: npt.NDArray[np.float64] | None"),
            ("eeg_data: npt.NDArray,", "eeg_data: npt.NDArray[np.float64],"),
            ("ax: plt.Axes", 'ax: "plt.Axes"'),
            ("axes: list[plt.Axes] | plt.Axes", 'axes: list["plt.Axes"] | "plt.Axes"'),
        ],
        ...
        "src/brain_go_brrr/core/snippets/maker.py": [
            ("eegpt_results: dict", "eegpt_results: dict[str, Any]"),
        ],
        # Fix models
        "src/brain_go_brrr/models/eegpt_architecture.py": [
            ("n_channels: list | None = None,", "n_channels: list[int] | None = None,"),
            (
        ...
        "src/brain_go_brrr/data/tuab_enhanced_dataset.py": [
            ...
            ("-> List[Tuple[np.ndarray, int]]:", "-> List[Tuple[npt.NDArray[np.float64], int]]:"),
        ],
        ...
        "src/brain_go_brrr/training/sleep_probe_trainer.py": [
            ...
            ("windows: list[np.ndarray],", "windows: list[npt.NDArray[np.float64]],"),
            (") -> tuple[float, np.ndarray]:", ") -> tuple[float, npt.NDArray[np.float64]]:"),
            (
        ...
        "src/brain_go_brrr/core/features/extractor.py": [
            ...
            ("-> list[np.ndarray]:", "-> list[npt.NDArray[np.float64]]:"),
            (") -> list[np.ndarray]:", ") -> list[npt.NDArray[np.float64]]:"),
            ("self, windows: list[np.ndarray],", "self, windows: list[npt.NDArray[np.float64]],"),
        ],
