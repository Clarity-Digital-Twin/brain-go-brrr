...
class TestEEGPTMicrobenchmark:
    ...
    @pytest.mark.parametrize("batch_size,time_samples", [(1, 512), (1, 1024), (1, 2048), (4, 1024)])
    def test_extract_features_scaling(self, batch_size, time_samples):
        ...
        model.encoder.extract_features = MagicMock(return_value=torch.zeros(batch_size, 512))
