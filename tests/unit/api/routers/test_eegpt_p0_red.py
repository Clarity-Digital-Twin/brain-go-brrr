...
class TestP0CriticalFixes:
    ...
    def test_analyze_endpoint_dimension_mismatch(self, test_client, valid_edf_bytes, stub_edf_loader):
        """
    ...
    def test_sleep_stages_endpoint_dimension_mismatch(self, test_client, valid_edf_bytes, stub_edf_loader):
        """
    ...
    def test_analyze_batch_endpoint_dimension_mismatch(self, test_client, valid_edf_bytes, stub_edf_loader):
        """
