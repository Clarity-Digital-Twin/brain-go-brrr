...
class TestEnhancedAbnormalityDetection:
    ...
    def probe(self):
        ...
        with patch(
            ...
            return EnhancedAbnormalityDetectionProbe(
                checkpoint_path="mock_checkpoint.ckpt", n_channels=20, n_classes=2
            )
    ...
    def test_probe_initialization(self):
        ...
        with patch(
            ...
            probe = EnhancedAbnormalityDetectionProbe(
                checkpoint_path="test.ckpt", learning_rate=5e-4, weight_decay=0.05
            )
    ...
    def test_freeze_backbone_setting(self, probe):
        ...
        with patch(
            ...
            probe_unfrozen = EnhancedAbnormalityDetectionProbe(
                checkpoint_path="test.ckpt", freeze_backbone=False
            )
    ...
    def test_scheduler_types(self):
        ...
        for scheduler_type in ["onecycle", "cosine", "none"]:
            with patch(
                ...
                probe = EnhancedAbnormalityDetectionProbe(
                    checkpoint_path="test.ckpt", scheduler_type=scheduler_type
                )
    ...
    def test_layer_decay_configuration(self):
        ...
        with patch(
            ...
            probe = EnhancedAbnormalityDetectionProbe(checkpoint_path="test.ckpt", layer_decay=0.65)
