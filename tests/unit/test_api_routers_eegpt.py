...
class TestEEGPTRouterClean:
    ...
    def test_analyze_with_probe_abnormality(
        self, mock_get_model, mock_get_probe, mock_load_edf,
        mock_eegpt_model, mock_abnormality_probe, valid_edf_bytes, test_client
    ):
    ...
    def test_analyze_with_probe_sleep(
        self, mock_get_model, mock_get_probe, mock_load_edf,
        mock_eegpt_model, mock_sleep_probe, valid_edf_bytes, test_client
    ):
    ...
    @patch("brain_go_brrr.api.routers.eegpt.load_edf_safe")
    def test_analyze_with_probe_edf_load_error(
        self, mock_load_edf, valid_edf_bytes, test_client
    ):
    ...
    def test_analyze_batch(
        self, mock_get_model, mock_get_probe, mock_load_edf,
        mock_eegpt_model, valid_edf_bytes, test_client
    ):
        ...
        mock_probe = MagicMock()
        mock_probe.predict_proba = MagicMock(
            return_value=torch.tensor([[0.7, 0.3], [0.6, 0.4]])
        )
    ...
    def test_analyze_batch_fallback_probe(
        self, mock_get_model, mock_load_edf,
        mock_eegpt_model, valid_edf_bytes, test_client
    ):
