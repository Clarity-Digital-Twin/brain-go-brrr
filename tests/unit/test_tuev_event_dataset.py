...
6000000 6500000 bckg"""
    ...
    def test_dataset_length_matches_segments(self):
        ...
        for i in range(n_segments):
            ...
            segments.append({'file': f'segment_{i}.pt', 'label': i % 6, 'subject': f'sub{i//3:03d}'})
    ...
    def test_no_sliding_windows(self):
        ...
        with patch('brain_go_brrr.infra.data.tuev_event_dataset.TUEVEventExtractor') as mock_ext_class:
            mock_extractor = Mock()
