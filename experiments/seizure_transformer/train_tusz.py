...
def main():
    ...
    # Try to load pretrained wu_2025 model if available
    try:
        import wu_2025

        print("Loading pretrained SeizureTransformer from wu_2025 package")
        model = wu_2025.SeizureTransformer()
    except ImportError:
        print("wu_2025 package not available, using wrapper with random init")
