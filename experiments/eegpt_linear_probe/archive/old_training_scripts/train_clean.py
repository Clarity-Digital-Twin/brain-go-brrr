#!/usr/bin/env python
"""Clean training script for EEGPT Linear Probe on TUAB.

This script has all channel mapping fixes and uses paper-faithful settings.
"""
...
print("=" * 60)
print("EEGPT Linear Probe Training - Clean Run")
print("=" * 60)
