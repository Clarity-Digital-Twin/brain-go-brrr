...
### Channel Note
- TUEV raw files lack Fpz but EEGPT expects it
- We synthesize Fpz as zeros (see `TUEV_FPZ_DISCREPANCY.md`)
- Optional: Learnable 1×1 Conv adapter (authors' approach)
